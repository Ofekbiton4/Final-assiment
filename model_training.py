...
# Normelized the Values
max_value_Area = dataframe['Area'].max()
min_value_Area = dataframe['Area'].min()
max_value_RoomNumber = dataframe['room_number'].max()
min_value_RoomNumber = dataframe['room_number'].min()

with open('file_values.txt', 'w') as file:
    file.write(f"Max Value: {max_value_Area}\n")
    file.write(f"Min Value: {min_value_Area}\n")
    file.write(f"Max Value: {max_value_RoomNumber}\n")
    file.write(f"Min Value: {min_value_RoomNumber}\n")
