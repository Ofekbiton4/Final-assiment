...
def update_bool_column(dataframe):
    ...
    for column_name in columns_to_convert:
        ...
        #print(dataframe[column_name])
        #dataframe[column_name] = dataframe[column_name].replace(mapping).astype(int) # this is an invalid request, probably the former line is enough for what you tried to do
        #print(dataframe[column_name])
